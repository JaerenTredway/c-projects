...
int main(int argc, char *argv[])
{
    ...
    //variables:
    char    str[30]; //stores one line of input
    ...
    int     lastIndex; //the last index of the input string (is not the \0)
    ...
    while (fgets(str, 30, stdin)) //runs until EOF when str will point to NULL
    {
        ...
        //process one line of input and run the indicated command:
        switch (command)
        {
